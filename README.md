...
- MVP API: `/api/mvp/state`, `/api/mvp/orders`, accept/decline/start/complete/review/messages
- Обязательное закрытие заказа: клиент подтверждает самостоятельную оплату и оценивает мастера, мастер оценивает клиента
